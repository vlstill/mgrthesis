...
\usepackage{float}
\makeatletter
% custom float style, derived from ruled, but caption is at the bottom and
...
\newcommand\fs@botruled{\def\@fs@cfont{\bfseries}\let\@fs@capt\floatc@botruled
    ...
    \def\@fs@post{\kern2pt\hrule height.8pt depth0pt\relax}%
    \def\@fs@mid{\kern4pt\hrule\kern2pt}%
