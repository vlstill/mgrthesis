...
\section*{Keywords}
\Mc, \llvm, Verification, \divine, \lart, \llvm-to-\llvm Transformation,
Implementation
...
\chapter{Feature Extension through \llvm-to-\llvm Transformations}
\input{extend}

\chapter{State Space Reduction through \llvm-to-\llvm Transformations}
\input{reduce}
